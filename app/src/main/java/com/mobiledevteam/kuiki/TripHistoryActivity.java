...
//        setupDrawerContent(nvDrawer);
    ...
    private void onSetMenuEvent() {
        btn_go_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(TripHistoryActivity.this, UserProfileActivity.class);
...
//                finish();
        ...
        btn_user_privacy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(TripHistoryActivity.this, ProtectionActivity.class);
                startActivity(intent);
                finish();
            }
        });
        btn_user_setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(TripHistoryActivity.this, UserSettingActivity.class);
                startActivity(intent);
                finish();
            }
        });
...
//                    mDatabase.getReference("user/"+mAuth.getUid()+"/phonenumber").setValue(phone_token);
                    Intent intent = new Intent(TripHistoryActivity.this, OffersActivity.class);
                    startActivity(intent);
                    finish();
                }else{
                    onCheckVerify();
                        ...
                        public void onCompleted(Exception e, JsonObject result) {
                            if (result != null) {
                                ...
                                if (res.equals("ok")) {
                                    ...
                                    if(id_request == 0) {
                                        Intent intent = new Intent(TripHistoryActivity.this, VerifyActivity.class);
                                        startActivity(intent);
                                        finish();
