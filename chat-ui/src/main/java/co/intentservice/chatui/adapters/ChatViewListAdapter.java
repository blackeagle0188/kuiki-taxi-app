...
public class ChatViewListAdapter extends BaseAdapter {
    ...
    public ChatViewListAdapter(Context context, ViewBuilderInterface viewBuilder, int backgroundRcv, int backgroundSend, int bubbleBackgroundRcv, int bubbleBackgroundSend, float bubbleElevation, int textColorRcv, int textColorSend, int tStampColorRcv, int tStampColorSend) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder = new MessageViewHolder(convertView, backgroundRcv, backgroundSend, bubbleBackgroundRcv, bubbleBackgroundSend, textColorRcv, textColorSend, tStampColorRcv, tStampColorSend);
        ...
        holder.setSeenStatus(chatMessages.get(position).getStatus());
